...
if __name__ == '__main__':
    ...
    # After the loop completes, calculate the average of the average returns if eval_hist is not empty
    if eval_hist:
        overall_avg_return = sum(eval_hist) / len(eval_hist)
        print(f"Overall Average Return: {overall_avg_return}")
        # Optionally save or process this value further
